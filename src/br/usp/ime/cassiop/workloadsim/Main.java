		...
		try {
			...
			if (options.has(placementArg)) {
				for (String value : placementArg.values(options)) {
					...
					if (value.equals("ffd")) {
						placementsToUse.add(PlacementType.FIRST_FIT_DEC);
					} else if (value.equals("bfd")) {
						placementsToUse.add(PlacementType.BEST_FIT_DEC);
					} else if (value.equals("wfd")) {
						placementsToUse.add(PlacementType.WORST_FIT_DEC);
					} else if (value.equals("khanna")) {
